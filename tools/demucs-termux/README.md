...
> **សំខាន់៖** អ្នក **មិនត្រូវការអ្នកអភិវឌ្ឍ** សម្រាប់ការប្តូរ URL ទេ។ កម្មវិធីលែងកំណត់ URL
> ជាប់ក្នុងកូដទៀតទេ (`PINNED_SEPARATOR_URL = ''`)។ លំដាប់ដែលវាប្រើគឺ៖
>
> 1. URL ដែលអ្នករក្សាទុកក្នុងកាត «ញែកភ្លេង» — នេះជាចម្បង។
> 2. `AUDIO_SEPARATOR_URL` ក្នុង environment — ប្រើបន្ទាប់ពីនោះ។
>
> ដូច្នេះពេល tunnel បើកឡើងវិញ ហើយទទួល URL ថ្មី គ្រាន់តែ paste ថ្មីក្នុងកាត រួចចុច
> **«រក្សាទុក និងសាកល្បង»** ម្តងទៀត — គ្មាន push គ្មាន deploy គ្មានរង់ចាំអ្នកណាទេ។
...
4. ចុច **«រក្សាទុក និងសាកល្បង»** — វារក្សាទុកជាប់ ហើយសាកល្បងជាមួយគ្នា។
